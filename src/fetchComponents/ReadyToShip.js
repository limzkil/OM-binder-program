...
export default function ReadyToShip() {
  ...
  let columns = [
    ...
    { title: "Apt/PO Box", field: "address.address2", export: true  },
    { title: "City", field: "address.city", export: true  },
    { title: "State", field: "address.state", export: true  },
    { title: "ZipCode", field: "address.zip", export: true  },
